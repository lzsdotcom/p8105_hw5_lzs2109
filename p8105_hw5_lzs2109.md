...
```
    ...
    ## # A tibble: 6 × 5
    ##   treatment subject_id group    week data_value
    ##   <chr>     <chr>      <chr>   <dbl>      <dbl>
    ## 1 con_01    01         control     1       0.2 
    ## 2 con_01    01         control     2      -1.31
    ## 3 con_01    01         control     3       0.66
    ## 4 con_01    01         control     4       1.96
    ## 5 con_01    01         control     5       0.23
    ## 6 con_01    01         control     6       1.09
...
had lower starting data values than subjects in the control group. The
starting (week 1) data values were not discernible between control and
treatment groups but by the end of week 8, all control data values were
below 2.5 while all treatment data values were above 2.5 with no
exceptions.
